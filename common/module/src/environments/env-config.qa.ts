...
export class EnvConfig {
    ...
    // };
    // backendBaseUrl = 'https://aet-backend-service.qa.35.202.28.191.nip.io'
    authKey = {
    ...
    backendBaseUrl = 'https://goaaa-preprod-qa.apigee.net';
    analyticsTrackingCode = 'UA-132663377-1';
    projectId = 'aaa-mwg-trucktracker-qa';
    cloudLoggingKey = 'AIzaSyAHmiv9CAVdIChJYqAicPOiXfPuNMeV7YY';
    name = 'qa';
}
